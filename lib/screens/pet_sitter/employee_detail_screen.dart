                      ...
                      children: [
                        Column(
                          ...
                          children: [
                            ...
                            if (userDetail.data.address.isNotEmpty)
                              TextIcon(
                                spacing: 10,
                                edgeInsets:
                                const EdgeInsets.only(bottom: 8, top: 4),
                                ...
                                prefix: Assets.navigationIcHomeOutlined
                                    .iconImage(fit: BoxFit.contain),
                                text: userDetail.data.address,
                                textStyle: secondaryTextStyle(),
                                expandedText: true,
                              ),
                            // if (userDetail.data.address.isNotEmpty)
                            ...
                            Column(
                              children: businessHours.entries
                                  .where((entry) => entry.key != "Thursday")
                                  .map((entry) => Padding(
